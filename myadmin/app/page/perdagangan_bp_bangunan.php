<?php
if (isset($_POST['save'])) {
	$ubah_isi=mysqli_query($l,"UPDATE perdagangan_bp_bangunan SET isi_pbp_b='".$_POST['isi']."' WHERE id_pbp_b=1 ");
	if ($ubah_isi) {
			?>
			<script type="text/javascript">alert('Isi Berhasil Diubah !')
			document.location = "index2.php?page=perdagangan-bp-bangunan"
			</script>
		<?php
		}	
}
?>
<h2>Ubah Isi Halaman Perdagangan Besar Bahan dan Peralatan Bangunan</h2>
<br />
<center>
